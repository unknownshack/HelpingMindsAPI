...
namespace HelpingMinds
{
    ...
    public class EventsController : ControllerBase
    {
        ...
        public EventsController(HelpingMindsDataContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("id={date}")] 
        public async Task<ActionResult<IEnumerable<Event>>> GetEvent(string date)
        {
            return await _context.Events.Where(x => x.eventDate == DateTime.Parse(date)).ToListAsync();
        }
